...
namespace Inventory_Management
{
    public class Product
    {
        ...
        */
        ...
        public void InsertProduct(string barcode, string name, string description, int categoryID, int quantity, double costPrice, double sellingPrice)
        {
            ...
            try
            {
                ...
                string sqlStatement = $"INSERT INTO products (barcode, product_name, product_description, category_id, quantity, cost_price, selling_price) VALUES ('{barcode}', '{name}', '{description}', '{categoryID}', '{quantity}', '{costPrice}', '{sellingPrice}')";
        ...
        public void UpdateProduct(string barcode, string name, string description, int categoryID, int quantity, float costPrice, float sellingPrice)
        {
